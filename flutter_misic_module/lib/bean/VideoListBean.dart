...
Data data;
  ...
  factory VideoListBean.fromJson(Map<String,dynamic> json)=>VideoListBean(json['resourceId'],
      json['resourceType'],
...
class Data {
  ...
  factory Data.fromJson(Map<String,dynamic> json)=>Data(
      ...
      json['coverUrl'],
      json['duration'],
      json['artists'] ==null?[]:(json['artists'] as List<dynamic>).map((json)=>Artists.fromJson(json)).toList(),
