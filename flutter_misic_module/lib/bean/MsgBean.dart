...
class MsgBean {
  ...
  factory MsgBean.fromJson(Map<String, dynamic> json) =>
      _$MsgBeanFromJson(json);
...
class ToUser {
  ...
  ToUser(this.nickname, this.avatarUrl, this.description, this.userId);
...
class FromUser {
  ...
  FromUser(this.nickname, this.avatarUrl, this.description, this.userId);
