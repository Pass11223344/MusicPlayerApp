...
class CommentInfoBean {
  ...
  CommentInfoBean(
      this.comments, this.totalCount, this.sortType, this.cursor, this.hasMore);

  factory CommentInfoBean.fromJson(Map<String, dynamic> json) =>
      _$CommentInfoBeanFromJson(json);
