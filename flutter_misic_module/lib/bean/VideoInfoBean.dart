 ...
 factory VideoInfoBean.fromJson(Map<String,dynamic> json,String type){
  switch(type){
   case "mv":
    ...
    return VideoInfoBean(artistsList[0]['img1v1Url'],"${json['name']}${json['desc']}", artistsList[0]['name'], "", json['id'].toString(), json['commentThreadId'], 0, json['commentCount'], false);

   case"mlog":
    var json2 = json['resource'];
    return   VideoInfoBean(json2['profile']['avatarUrl'],"${json2['content']['text']}", json2['profile']['nickname'],json2['content']['video']['urlInfo']['url'], json['id'], json2['threadId'], json2['likedCount'], json2['commentCount'], json2['liked']);
