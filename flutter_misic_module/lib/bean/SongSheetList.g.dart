...
SongSheetList _$SongSheetListFromJson(Map<String, dynamic> json) =>
    SongSheetList(
        json['creator'] == null
            ? UserInfoBean("", "", "", 0, 0, 0, 0, 0, 0, 0, 0)
            : UserInfoBean.fromJson(json['creator'] as Map<String, dynamic>),
        ...
        json['subscribedCount'] == null
            ? 0
            : (json['subscribedCount'] as num).toInt(),
        json['cloudTrackCount'] == null
            ? 0
            : (json['cloudTrackCount'] as num).toInt(),
        json['coverImgUrl'] as String,
        json['name'] as String,
        json['description'] == null ? "" : json['description'] as String,
        json['updateFrequency'] == null
            ? ""
            : json['updateFrequency'] as String,
        json['backgroundCoverUrl'] == null
            ? ""
            : json['backgroundCoverUrl'] as String,
        json['detailPageTitle'] == null
            ? ""
            : json['detailPageTitle'] as String,
        json['sharedUsers'] == null
            ? []
            : (json['sharedUsers'] as List<dynamic>)
