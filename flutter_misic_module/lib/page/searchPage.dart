...
//单曲
  ...
  void initState() {
    ...
    keyboardVisibilityController.onChange.listen((bool visible) {
      if (visible) {
        ...
        // 键盘隐藏时的处理逻辑
        setState(() {
          if (!isOnclick && isResultOk) isOnclick = true;
        });
                            ...
                            Expanded(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (!isResultOk && resultDio != null)
                                      resultDio.cancelToken();
                                    ...
                                    if (!isOnclick) {
                                      ...
                                      if (keyboardVisibilityController
                                          .isVisible) _focusNode.unfocus();

                                      channel.invokeMethod(
                                          "back", {"origin": "not_intercept"});
                                    }
                                    setState(() {
                                      isOnclick = false;
                                      isResultOk = false;
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    if (!_textEditingController.text.isEmpty) {
                                      ...
                                      getResult(_textEditingController.text, 1,
                                          songOffset);
                                    }
                                  },
                                  child: Container(
                    ...
                    body: Stack(
                      children: [
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Wrap(
                                              spacing: 8.0,
                                              runSpacing: 4.0,
                                              children: searchHotList
                                                  .asMap()
                                                  .entries
                                                  .map((entry) {
                                                int index = entry.key;
                                                String chipText =
                                                    entry.value.searchWord;
                                            ...
                                            leading: Text(
                                              ...
                                              style: TextStyle(
                                                  color: index + 1 <= 3
                                                      ? Colors.red
                                                      : Colors.grey,
                                                  fontWeight: index + 1 <= 3
                                                      ? FontWeight.bold
                                                      : FontWeight.normal),
                                            ),
                                            title: Text(
                                              searchHotList[index].searchWord,
                                              overflow: TextOverflow.ellipsis,
                                            ),
                                            trailing: searchHotList[index]
                                                        .iconUrl ==
                                                    ""
                                                ? null
                                                : getCircularImg(
                                                    url: searchHotList[index]
                                                        .iconUrl,
                                                    size: 10,
                                                  ));
                                      })),
                                        ...
                                        onNotification: (scrollNotification) {
                                          ...
                                          if (scrollNotification
                                            ...
                                            if (currentTab == 0) {
                                              ...
                                              if (songSheetList?.length !=
                                                  songCount) {
                                                addMostList(_inputValue, 1000,
                                                    songSheetOffset + 1);
                                                setState(() {
                                                  songSheetOffset += 1;
                                                });
                                                  ...
                                                  isResultOk
                                                      ? TabBarView(
                                                          ...
                                                          children: [
                                                              ...
                                                              CustomScrollView(
                                                                key: PageStorageKey(
                                                                    "${_tabController.index}-THENumIS0"),
                                                                slivers: [
                                                                  ...
                                                                  SliverToBoxAdapter(
                                                                    child: Container(
                                                                        ...
                                                                        width: 35,
                                                                        height: songList?.length == songCount ? 100 : 35,
                                                                        alignment: Alignment.center,
                                                                        child: songList?.length != songCount
                                                              ...
                                                              CustomScrollView(
                                                                key: PageStorageKey(
                                                                    "${_tabController.index}-THENumIS1"),
                                                                slivers: [
                                                                  SliverFixedExtentList(
                                                                      delegate: SliverChildBuilderDelegate(
                                                                          childCount:
                                                                              songSheetList?.length,
                                                                          (context,
                                                                              index) {
                                                                        if (songSheetList ==
                                                                            null) {
                                                                  ...
                                                                  SliverToBoxAdapter(
                                                                    child: Container(
                                                                        ...
                                                                        margin: EdgeInsets.only(top: 10),
                                                                        width: 35,
                                                                        height: songSheetList?.length == songSheetCount ? 100 : 35,
                                                                        alignment: Alignment.center,
                                                                        child: songSheetList?.length != songSheetCount
                                                              ...
                                                              CustomScrollView(
                                                                key: PageStorageKey(
                                                                    "${_tabController.index}-THENumIS2"),
                                                                slivers: [
                                                                  SliverFixedExtentList(
                                                                      delegate: SliverChildBuilderDelegate(
                                                                          childCount:
                                                                  ...
                                                                  SliverToBoxAdapter(
                                                                    child: Container(
                                                                        ...
                                                                        margin: EdgeInsets.only(top: 10),
                                                                        width: 35,
                                                                        height: albumList?.length == albumCount ? 100 : 35,
                                                                        alignment: Alignment.center,
                                                                        child: albumList?.length != albumCount
                                                                            ? CircularProgressIndicator(
                                                                                color: Colors.red,
                                                                                strokeWidth: 1,
                                                                              )
                        ...
                        _inputValue != "" &&
                            ...
                            : Container(
                                color: Colors.white, height: 0, width: 0)
                      ],
                    ))),
          )
        : Container(
  ...
  void getHistoryList() async {
    ...
    if (HistoryLists != null) {
      setState(() {
        ...
        double len = 0.0;
        double width = roughlyWidth("msg") < warp_widh / 2 - 20
            ? roughlyWidth("msg") + 20
            : warp_widh / 2;
        if (!foldFlag) {
          history_list.remove("");
  ...
  jumpSearchResult(String value) {
    ...
    double len = 0.0;
    double width = roughlyWidth(value) < warp_widh / 2 - 20
        ? roughlyWidth(value) + 20
        : warp_widh / 2;
    if (!foldFlag) {
      history_list.remove("");
      for (int i = 0; i < history_list.length; i++) {
  ...
  getResult(String value, int type, int offset) async {
    ...
    var data;
    data = await resultDio.executeGet(
        url: "/cloudsearch", params: {"keywords": value, "type": type});
    if (data == "error") {
      setState(() {
        isNetOk = false;
      });
    ...
    switch (type) {
      case 1:
        ...
        break;
      case 10:
        albumList = (data['albums'] as List<dynamic>)
            .map((json) => Album.fromJson(json))
            .toList();
        albumCount = data['albumCount'];

      case 1000:
        songSheetList = (data['playlists'] as List<dynamic>)
  ...
  addMostList(String value, int type, int offset) async {
    ...
    data = await resultDio.executeGet(
        url: "/cloudsearch",
        params: {"keywords": value, "offset": offset, "type": type});
    if (data == "error") {
      setState(() {
        isNetOk = false;
      });
    ...
    switch (type) {
      case 1:
        songList?.addAll((data['songs'] as List<dynamic>)
            .map((json) => SongListBean.fromJson(json))
            .toList());
        // songCount = data['songCount'];
        break;
      case 10:
        albumList?.addAll((data['albums'] as List<dynamic>)
            .map((json) => Album.fromJson(json))
            .toList());
      case 1000:
        songSheetList?.addAll((data['playlists'] as List<dynamic>)
            .map((json) => SongSheetList.fromJson(json))
            .toList());
        break;
    }
  ...
  void getNteWorkData() async {
    ...
    setState(() {
      ...
      searchHotList = (data as List<dynamic>)
          .map((json) => SearchHotListBean.fromJson(json))
          .toList();
  ...
  void getSuggestData(String msg) async {
    ...
    var data = await suggestDio.executeGet(
        url: "/search/suggest", params: {"keywords": msg, "type": "mobile"});
    setState(() {
      suggestOk = true;
      suggestList = (data as List<dynamic>)
          .map((json) => json['keyword'] as String)
          .toList();
    });
  }
  ...
  _SongListItem(int index) {
    return ListTile(
      ...
      titleTextStyle: const TextStyle(
          ...
          fontWeight: FontWeight.bold),
      subtitle: Text(
        "${Utils.getSubTitle(songList![index].ar)}-${songList![index].al.name != null ? songList![index].al.name : ""}",
        maxLines: 1,
      ),
      ...
      onTap: () {
        if (lastSongId == songList?[index].id) return;
  ...
  _SongSheetListItem(int index) {
    return ListTile(
      leading: getSquareImg(
        Url: songSheetList![index].coverImgUrl,
        width: 55,
        height: 55,
      ),
      title: Text(
        songSheetList![index].name,
        maxLines: 1,
      ),
      titleTextStyle: const TextStyle(
          fontSize: 16,
          ...
          fontWeight: FontWeight.bold),
      subtitle: Text(
        "${songSheetList![index].trackCount}首,${songSheetList![index].creator.nickname},播放${Utils.formatNumber(songSheetList![index].playCount, '')}次",
        maxLines: 1,
      ),
      subtitleTextStyle: const TextStyle(
          fontSize: 12, color: Colors.grey, overflow: TextOverflow.ellipsis),
  ...
  _AlbumListItem(int index) {
    return ListTile(
      leading: getSquareImg(
        Url: albumList![index].picUrl,
        width: 55,
        height: 55,
      ),
      title: Text(
        "${albumList![index].name}${(albumList![index].alias.length == 0 ? "" : albumList![index].alias[0])}",
        maxLines: 1,
      ),
      titleTextStyle: const TextStyle(
          fontSize: 16,
          ...
          fontWeight: FontWeight.bold),
      subtitle: Text(
        "${Utils.getSubTitle(albumList![index].artists)}${Utils.formatDate(albumList![index].publishTime)}",
        maxLines: 1,
      ),
      subtitleTextStyle: const TextStyle(
          fontSize: 12, color: Colors.grey, overflow: TextOverflow.ellipsis),
