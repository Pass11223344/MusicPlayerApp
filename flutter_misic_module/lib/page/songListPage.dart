...
class songListPageState extends State<songListPage> {
                        ...
                        children: [
                          Container(
                              ...
                              child: TextButton.icon(
                                  ...
                                  label: Obx(() {
                                    return ListController.isSearch
                                        ? const Text("")
                                        : Text(
                                            "${type == "to_recommend_song" ? "每日推荐" : widget.data['title'] != null ? expandedHeight > eHeight / 2 ? widget.data['title'] : "歌单" : ListController.albumInfo != null ? (expandedHeight > eHeight / 2 ? ListController.albumInfo?.album.name : "专辑") : (ListController.songSheet?.detailPageTitle == null ? expandedHeight > eHeight / 2 ? ListController.songSheet?.name : "歌单" : expandedHeight > eHeight / 2 ? ListController.songSheet?.name : "官方歌单")}",
                                            style: TextStyle(
                                                fontSize: 16,
                                                color: Colors.black),
                                          );
                  ...
                  body: PopScope(
                    ...
                    child: Stack(
                      children: [
                          ...
                          headerSliverBuilder:
                            ...
                            return [
                              SliverOverlapAbsorber(
                                ...
                                sliver: SliverAppBar(
                                  backgroundColor: type == "to_recommend_song"
                                      ? Colors.white
                                      : ListController.imgColor,
                                  pinned: true,
                                  scrolledUnderElevation: 0.0,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                              "${Utils.formatNumber(ListController.albumInfo == null ? ListController.songSheet!.playCount : 0, "")}",
                                                                              style: TextStyle(
                                                                                fontSize: 10,
                                                                                color: Colors.white,
                                                                              ))
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Visibility(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          "歌手:${ListController.albumInfo != null ? Utils.getSubTitle(ListController.albumInfo?.album.artists) : ""}>",
                                                                  ...
                                                                  ListController
                                                                      ...
                                                                      : Obx(() {
                                                                          List<Widget>
                                                                              list =
                                                                              [];
                                                                          if (ListController.songSheet!.sharedUsers.length !=
                                                                              0) {
                                                                            list =
                                                                                ListController.songSheet!.sharedUsers.asMap().entries.map((entry) {
                                                                              int index = entry.key;
                                                                            ...
                                                                            list.add(Container(
                                                                              width: 30,
                                                                              height: 30,
                                                                              decoration: BoxDecoration(border: Border.all(color: Colors.white, width: 1), borderRadius: BorderRadius.circular(100)),
                                                                                  ...
                                                                                  child: Row(
                                                                                    ...
                                                                                    children: [
                                                                                      Container(
                                                                                        ...
                                                                                        child: Stack(
                                                                                            children: ListController.songSheet!.sharedUsers.length == 0
                                                                                                ? [
                                                                                                    Container(
                                                                                                      width: 30,
                                                                                                      height: 30,
                                                                                                      decoration: BoxDecoration(border: Border.all(color: Colors.white, width: 1), borderRadius: BorderRadius.circular(100)),
                                                                                                      child: getCircularImg(
                                                                                                        url: ListController.songSheet!.creator.avatarUrl,
                                                                                                        size: 30,
                                                                                                      ),
                                                                                                    )
                                                                                                  ]
                                                                                      ...
                                                                                      Flexible(
                                                                                          child: Container(
                                                                                              ...
                                                                                              child: Text(
                                                                                        "  ${ListController.songSheet!.sharedUsers.length == 0 ? ListController.songSheet!.creator.nickname : "${ListController.songSheet!.creator.nickname}等${ListController.songSheet!.sharedUsers.length + 1}人"}>",
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Visibility(
                                                                visible: ListController
                                                                    ...
                                                                    "",
                                                                child: Text(
                                                                  " ${ListController.songSheet?.description}>",
                                                                  style: TextStyle(
                                                                      fontSize:
                                                                          12,
                                                                      color: Colors
                                                                ...
                                                                if (ListController
                                                                  ...
                                                                  p = {
                                                                    ...
                                                                    "title": ListController
                                                                        ...
                                                                        .name,
                                                                    "subTitle":
                                                                        "歌手:${Utils.getSubTitle(ListController.albumInfo?.album.artists)}"
                                                                  };
                                                                } else {
                                                                  p = {
                                                                    "id": ListController
                                                                    ...
                                                                    "title": ListController
                                                                        ...
                                                                        .name,
                                                                    "subTitle":
                                                                        "创建者:${ListController.songSheet!.creator.nickname}"
                                                                  };
                                                                }
                                                                ListController
                                                                        .isOpenSheet =
                                                                ...
                                                                if (ListController
                                                                  ...
                                                                  p = {
                                                                    ...
                                                                    "userId":
                                                                        pageController
                                                                            .userId,
                                                                    "imgUrl": ListController
                                                                        .albumInfo!
                                                                        .album
                                                                        .blurPicUrl,
                                                                    "songName": ListController
                                                                        .albumInfo!
                                                                        .album
                                                                        .name,
                                                                    "singerName": Utils.getSubTitle(ListController
                                                                        .albumInfo
                                                                        ?.album
                                                                        .artists)
                                                                  };
                                                            ...
                                                            child:
                                                                TextButton.icon(
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (ListController
                                                                        ...
                                                                        if (ListController
                                                                          ...
                                                                          ListController.setLiked(
                                                                              true);
                                                                          dioRequest.executeGet(
                                                                              url: '/album/sub',
                                                                              params: {
                                                                                't': 1,
                                                                                'id': ListController.albumInfo!.album.id
                                                                              });
                                                                        }
                                                                      } else {
                                                                        if (ListController
                                                                          ...
                                                                          dioRequest.executeGet(
                                                                              ...
                                                                              params: {
                                                                                't': 1,
                                                                                'id': ListController.songSheet!.id
                                                                              });
                                                                        }
                                                                      }
                                                                    ...
                                                                    label: Text(
                                                                        ...
                                                                        Utils.formatNumber(
                                                                            ListController.albumInfo != null
                                                                                ? ListController.albumInfo!.album.info.likedCount
                                                                                : ListController.songSheet!.subscribedCount,
                                                                            "收藏")),
                                                                    icon: Obx(() {
                                                                      return ListController.albumInfo !=
                                                                              null
                                                                          ? ListController.albumInfo!.album.info.liked
                                                                              ? Icon(
                                                                          ...
                                                                          : ListController.songSheet!.subscribed
                                                                              ? Icon(
                                                                                  Icons.library_add_check,
                                                                                  color: Colors.redAccent,
                                                                                  size: 24,
                                  ...
                                  bottom: PreferredSize(
                                    ...
                                    child: Container(
                                        ...
                                        child: TextButton.icon(
                                            onPressed: () {},
                                            label: Text(
                                              "播放全部(${type == "to_recommend_song" ? ListController.songList.length : ListController.albumInfo != null ? ListController.albumInfo!.songs.length : ListController.songSheet!.cloudTrackCount + ListController.songSheet!.trackCount})",
                                              style: TextStyle(
                                                  fontSize: 16,
                              ...
                              return NotificationListener<ScrollNotification>(
                                onNotification: (scrollNotification) {
                                  ...
                                  if (scrollNotification
                                    ...
                                    if (type == "to_recommend_song")
                                      return true;
                                    if (ListController.songList.length !=
                                        ListController.songSheet?.trackCount) {
                                      if (!ListController.showSongsIsOk)
                                        addMoreList();
                                    }
                                    ;
                                    ...
                                    Obx(() {
                                      return SliverFixedExtentList(
                                        delegate: SliverChildBuilderDelegate(
                                            childCount: type ==
                                                    "to_recommend_song"
                                                ? ListController.songList.length
                                                : ListController.albumInfo !=
                                                        null
                                                    ? ListController
                                                        .albumInfo!.songs.length
                                                    : ListController
                                                        .songList?.length,
                                            (context, index) {
                                          if (ListController.albumInfo !=
                                              null) {
                                            ListController
                                                .albumInfo?.songs[index].al
                                                .pic(ListController
                                                        ...
                                                        const TextStyle(
                                                            ...
                                                            fontWeight:
                                                                FontWeight
                                                                    .bold),
                                                    subtitle: Text(
                                                      "${Utils.getSubTitle(ListController.songList[index].ar)}-${ListController.songList[index].al.name != "" ? ListController.songList[index].al.name : ""}",
                                                      maxLines: 1,
                                                    ),
                                                    subtitleTextStyle:
                                                        const TextStyle(
                                        ...
                                        itemExtent: type == "to_recommend_song"
                                            ? 70
                                            : 55,
                                      );
                                    }),
                                    SliverToBoxAdapter(
                                        child: type == "to_recommend_song"
                                            ? SizedBox(
                                                height: 100,
                                              )
                                            : Obx(() {
                                                return Container(
                                                    color: Colors.white,
                                                    width: 70,
                                                    height: ListController.songList.length ==
                                                                ListController
                                                                    .songSheet
                                                                    ?.trackCount ||
                                                            ListController.songList.length ==
                                                        ...
                                                        : 70,
                                                    alignment: Alignment.center,
                                                    child: (ListController.songSheet != null
                                                            ? ListController
                                                                    .songList
                                                                    .length !=
                                                                ListController.songSheet!.cloudTrackCount +
                                                                    ListController
                                                                        .songSheet!
                                                                        .trackCount
                                                            : ListController
                                                          ...
                                                          const TextStyle(
                                                              ...
                                                              fontWeight:
                                                                  FontWeight
                                                                      .bold),
                                                      subtitle: Text(
                                                        "${Utils.getSubTitle(ListController.albumInfo?.songs[index].ar)}${ListController.albumInfo?.songs[index].al.name != "" ? "-${ListController.albumInfo?.songs[index].al.name}" : ""}",
                                                        maxLines: 1,
                                                      ),
                                                      subtitleTextStyle:
                                                          const TextStyle(
                        ...
                        Obx(() {
                          return !ListController.isContain &&
                                  ListController.text != ""
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          style: TextStyle(
                                              fontSize: 12,
                                              color: Colors.black),
                                          " ${ListController.albumInfo != null ? ListController.albumInfo!.album.description == "" ? "暂无描述" : ListController.albumInfo!.album.description : ListController.songSheet?.description == "" ? "暂无描述" : ListController.songSheet?.description}")
                                    ],
                                  ),
                                ),
                              ),
                                    ...
                                    child: TextButton(
                                      onPressed: () async {
                                        var url =
                                            ListController.albumInfo != null
                                                ? ListController
                                                    .albumInfo!.album.blurPicUrl
                                                : ListController
                                                    .songSheet!.coverImgUrl;
                                        // 按钮点击事件
                                        if (await Utils.requestPermission({
                                          "info": url,
                                          "origin": "secondFragment"
                                        })) {
                                          pageController.path ??= await channel
                                              .invokeMethod("getPath");
                                          Utils.downloadImage(
                                                  url, pageController.path)
                                              .then((flag) {
                ...
                onPressed: () {
                  switch (type) {
                    case "album":
                      ...
                      dioRequest.executeGet(url: '/album/sub', params: {
                        't': 2,
                        'id': ListController.albumInfo!.album.id
                      });
                      break;
                    case "sheet":
                      ...
                      dioRequest.executeGet(
                          url: '/playlist/subscribe',
                          params: {'t': 2, 'id': ListController.songSheet!.id});
                      break;
                  }
  ...
  getData(String id) async {
    ...
    switch (widget.data['type']) {
      ...
      case "to_sheet":
      case "to_ranking":
        var SongSheet = await dioRequest
            .executeGet(url: "/playlist/detail", params: {"id": id});
        var SList = await dioRequest.executeGet(
        ...
        Future.microtask(() async {
          ...
          if (SongSheet != "error" && SList != "error") {
            ...
            ListController.imgColor = await _getPaletteGenerator(
                ListController.songSheet!.coverImgUrl);
      ...
      case "to_sing_and_albums":
        var album = await dioRequest
            .executeGet(url: "/album", params: {"id": widget.data['id']});
      ...
      case "to_recommend_song":
        ...
        if (SList != "error") {
          ListController.songList = (SList['dailySongs'] as List<dynamic>)
              .map((json) => SongListBean.fromJson(json))
              .toList();
          pageController.pageIsOk = true;
        }
  ...
  void addMoreList() async {
    ...
    var SList = await dioRequest.executeGet(
        ...
        params: {
          "id": widget.data['id'],
          "limit": 100,
          "offset": ListController.songList?.length
        });
    ListController.addSongList((SList['songs'] as List<dynamic>)
        .map((json) => SongListBean.fromJson(json))
        .toList());
  ...
  Future<void> showCreator() async {
    ...
    if (ListController.songSheet != null) {
      ...
      if (list.length > 0) {
        if (list[0].userId != ListController.songSheet!.creator.userId)
          ...
          builder: (BuildContext context, ScrollController scrollController) {
            return Container(
              ...
              child: ListView.builder(
                ...
                itemCount: ListController.albumInfo != null
                    ? ListController.albumInfo?.album.artists.length
                    : ListController.songSheet!.sharedUsers.length,
                itemBuilder: (BuildContext context, int index) {
                  return ListTile(
                    leading: ListController.songSheet != null
                        ? getCircularImg(
                            url: ListController
                                .songSheet!.sharedUsers[index].avatarUrl,
                            size: 50,
                          )
                        : null,
                    title: Text(ListController.albumInfo != null
                        ? ListController.albumInfo!.album.artists[index].name
                        : ListController
                            .songSheet!.sharedUsers[index].nickname),
                  );
                },
              ),
            );
