...
// late List<Player> _players;
    ...
    _pageController.addListener(() async {
      ...
      if (!_pageController.page!.isNaN &&
        ...
        if (_myPageController.videoInfoBean[currentPage] == null) {
          ...
          if (_myPageController.getPlayer(
                  _myPageController.videoInfoBean[currentPage]!.url) ==
              null) {
            _myPageController.createPlayer(
                _myPageController.videoInfoBean[currentPage]!.url,
                true,
                SourceType.nte);
          } else {
            print("object---------1");
            _myPageController
                .getPlayer(_myPageController.videoInfoBean[currentPage]!.url)!
                .start();
          }
        }
        ...
        body: PopScope(
          ...
          child: PageView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return Obx(() {
                  return _myPageController.videoList[index].resourceType ==
                              "MV" ||
                          _myPageController.videoList[index].resourceType ==
                              "MLOG"
                      ? index > _myPageController.videoInfoBean.length ||
                              _myPageController.videoInfoBean[index] == null
                          ? Container(
                              color: Colors.black,
                              child: const Center(
                                child: Text(
                          ...
                          : item(
                              _myPageController.getPlayer(
                                  _myPageController.videoInfoBean[index]!.url),
                              index)
                      : Container(
                          color: Colors.black,
                          child: const Center(
  ...
  item(Player? player, int index) {
    return Stack(
      children: [
        Obx(() {
          return AnimatedPadding(
            padding: EdgeInsets.only(
                bottom: _myPageController.paddingH,
                right: _myPageController.paddingW,
                left: _myPageController.paddingW),
            ...
            child: Container(
              ...
              child: favorite(
                  ...
                  child: player == null
                      ? Center(
                          child: AspectRatio(
                              aspectRatio: _myPageController
                                      .videoInfoBean[index]?.videoAspectRatio ??
                                  16 / 9, // 默认宽高比
                              child: _myPageController
                                          .videoList[index].data.coverUrl ==
                                      ""
                                  ? Container(
                                      color: Colors.black,
                                    )
                                  : getCover(_myPageController
                                      .videoList[index].data.coverUrl)))
                      : videoView(
                          cover:
                              _myPageController.videoList[index].data.coverUrl,
                          player: player,
                          changeProgress: (type) {
                            switch (type) {
                              case 'HideControl':
                          ...
                          AspectRatio: (double videoAspectRatio) {
                            _myPageController.videoInfoBean[index]
        ...
        Obx(() {
          return _myPageController.needHide
              ? const SizedBox()
              : Stack(
                  children: [
                    Container(),
                          ...
                          children: [
                              ...
                              children: [
                                Obx(() {
                                  return IconButton(
                                      ...
                                      icon: _myPageController
                                              .videoInfoBean[index]!.liked
                                          ? Icon(
                                              Icons.favorite,
                                              size: 40,
                                              color: Colors.red,
                                ...
                                Obx(() {
                                  return Text(
                                      "${_myPageController.videoInfoBean[index]!.likedCount}",
                            ...
                            Column(
                              children: [
                                IconButton(
                                    onPressed: () {
                                      _myPageController.paddingH =
                                          screenSize!.height * (2 / 3) - 20;
                                      _myPageController.paddingW = 80.0;
                                      _myPageController.myPageIsShow = false;
                                      if (_myPageController.viewPageComment![
                                              _myPageController
                                                  .videoInfoBean[index]!.id] ==
                                          null) {
                                        getCommentDate(
                                            _myPageController
                                                .videoList[index].resourceType,
                                            _myPageController
                                                .videoInfoBean[index]!.id);
                                      }
                                      showSheet(
                                ...
                                Obx(() {
                                  return Text(
                                    "${_myPageController.videoInfoBean[index]!.commentCount}",
                                    style: TextStyle(color: Colors.white),
                                  );
                                })
                              ],
                    ...
                    Positioned(
                        ...
                        child: Obx(() {
                          return Container(
                              constraints: _myPageController.descriptionH ==
                                      screenSize!.height * 0.5
                                  ? BoxConstraints(
                                      maxHeight:
                                          _myPageController.descriptionH!)
                                  : null,
                              height: _myPageController.descriptionH ==
                                      screenSize!.height * 0.5
                                  ? null
                                  : _myPageController.descriptionH, //0.5//0.08
                              width: screenSize!.width * 0.8,
                              child: _myPageController.descriptionH !=
                                      screenSize!.height * 0.5
                                  ? Column(
                                      crossAxisAlignment:
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          ...
                                          children: [
                                            ...
                                            Visibility(
                                                visible: calculateNumberOfLines(
                                                        "s", 20) <
                            ...
                            slivers: [
                              SliverList.builder(
                                  itemCount: controller
                                      .viewPageComment![id]!.comments.length,
                                  itemBuilder: (context, index) {
                                    return commentItem(
                                        info: controller.viewPageComment![id]!
                                            .comments[index],
                                        id: id,
                                        type: type);
                                  })
  ...
  getData(int index, bool isFirst) async {
    ...
    if (_myPageController.videoList[index].resourceType == "MV") {
      dioRequest.executeGet(url: "/mv/url", params: {"id": id}).then((v) async {
        var url = v["url"];
        dioRequest
            .executeGet(url: "/mv/detail", params: {"mvid": id}).then((value) {
          var videoInfoBean = VideoInfoBean.fromJson(value, "mv");
          videoInfoBean.url = url;
          if (!isFirst) {
            print("object----sdsds${_currentPage}-----}");
            if (_myPageController.videoInfoBean[_currentPage] != null) {
              _myPageController.insertVideoInfoBean(
                  index, videoInfoBean, false);
              return;
            }
          }
  ...
  void getCommentDate(String resourceType, String id) {
    if (resourceType == "MV") {
      dioRequest.executeGet(
          url: "/comment/new",
          params: {"id": id, "type": 1, "pageSize": 200}).then((value) {
        if (value != "error") {
          _myPageController.addViewPageComment(
              id, CommentInfoBean.fromJson(value));
          print("我都却dadjak${_myPageController.viewPageComment![id]!.hasMore}");
        }
      });
    } else if (resourceType == "MLOG") {
      dioRequest
          .executeGet(url: "/mlog/to/video", params: {"id": id}).then((value) {
        if (value != "error") {
          dioRequest.executeGet(
              url: "/comment/new",
              params: {"id": value, "type": 5, "pageSize": 200}).then((value) {
            if (value != "error") {
              _myPageController.addViewPageComment(
                  id, CommentInfoBean.fromJson(value));
              print(
                  "我都却dadjak${_myPageController.viewPageComment![id]!.hasMore}");
            }
          });
        }
      });
...
class commentItem extends StatefulWidget {
  ...
  const commentItem(
      {super.key, required this.info, required this.id, required this.type});
...
class commentItemState extends State<commentItem> {
            ...
            child: Column(
              ...
              children: [
                        ...
                        text: TextSpan(
                          ...
                          WidgetSpan(
                              child: Text(
                                  ...
                                  widget.info.content)),
                          calculateNumberOfLines(widget.info.content, null) >
                                  calculateNumberOfLines("s", null) * 5
                              ? TextSpan(
                ...
                Row(
                  children: [
                    Text(
                        "${widget.info.timeStr} · ${widget.info.ipLocation.location}")
                  ],
                ),
                beReplay != null
                    ? Visibility(
                        ...
                        child: Column(
                            children:
                                beReplay!.comments.asMap().entries.map((entry) {
                          ...
                          return Padding(
                            ...
                            child: replyCommentItem(
                                beReplied: value,
                                parentId: widget.info.commentId),
                          );
                        }).toList()))
                    : const SizedBox(),
                      ...
                      children: [
                        Visibility(
                          ...
                          child: TextButton.icon(
                            onPressed: () {
                              ...
                              if (beReplay != null) {
                                if (beReplay!.hasMore) {
                                  ...
                                  onclickCount += 1;
                                  getMoreReplay(
                                      widget.info.commentId,
                                      widget.type,
                                      widget.id,
                                      beReplay != null
                                          ? beReplay!
                                              .comments[
                                                  beReplay!.comments.length - 1]
                                              .time
                                          : null);
                                }
                            ...
                            icon: Text(
                              "----${isLoading ? "加载中......" : onclickCount == 0 ? "展开${widget.info.replyCount}条回复" : "展开更多回复"}",
                              style: TextStyle(color: Colors.black),
                            ),
                          ),
                        ),
  ...
  void getMoreReplay(
      int commentId, String resourceType, String id, int? timer) {
    if (resourceType == "MV") {
      ...
      dioRequest
          .executeGet(url: "/comment/floor", params: params)
          .then((value) {
        if (value != "error") {
...
class replyCommentItem extends StatefulWidget {
  ...
  const replyCommentItem(
      {super.key, required this.beReplied, required this.parentId});
...
class replyCommentItemState extends State<replyCommentItem>
  ...
  Widget build(BuildContext context) {
    // TODO: implement build
    print(
        "object-----拿的id是${widget.parentId}----huifuid${widget.beReplied.beReplied[0].beRepliedCommentId}");
    return SizedBox(
      width: MediaQuery.of(context).size.width * 0.8,
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          getCircularImg(
            url: widget.beReplied.user.avatarUrl,
            size: 35,
          ),
          const SizedBox(
            width: 10,
          ...
          Flexible(
            ...
            children: [
              Text(
                  "${widget.beReplied.user.nickname} ${widget.parentId != widget.beReplied.beReplied[0].beRepliedCommentId ? "> ${widget.beReplied.beReplied[0].user.nickname}" : ""}",
                  style: const TextStyle(
                ...
                children: [
                  RichText(
                      text: TextSpan(
                        ...
                        calculateNumberOfLines(widget.beReplied.content, null) >
                                calculateNumberOfLines("s", null) * 5
                            ? TextSpan(
                                style: TextStyle(color: Colors.black),
                                text: isOpen ? "收起" : "展开",
              ...
              Row(
                children: [
                  Text(
                      "${widget.beReplied.timeStr} · ${widget.beReplied.ipLocation.location}")
                ],
              ),
            ],
          ))
