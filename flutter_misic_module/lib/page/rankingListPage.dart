...
class rankingListPageSatate extends State<rankingListPage> {
                ...
                slivers: [
                  ...
                  SliverFixedExtentList(
                      delegate: SliverChildBuilderDelegate(childCount: 4,
                        ...
                        return InkWell(
                          onTap: () {
                            Navigator.pushNamed(context, "main/songListPage2",
                                arguments: {
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    getSquareImg(
                                        Url: rankingList![index].coverImgUrl,
                                        width: 60,
                                        height: 60),
                                    Flexible(
                                        child: Container(
                                      ...
                                      child: Column(
                                          ...
                                          children: rankingList![index]
                                            ...
                                            int index = entry.key;
                                            return Text(
                                              "${index + 1} ${entry.value.first} - ${entry.value.second}",
  ...
  void getData() {
    dioRequest.executeGet(url: "/toplist/detail").then((value) {
      rankingList = (value['list'] as List<dynamic>)
          .map((json) => RankingListBean.fromJson(json))
          .toList();
      setState(() {});
    });
  }
