...
@override
    ...
    return Obx((){
      return  controller.pageIsOk ? Scaffold(
          ...
          appBar: AppBar(
            ...
            toolbarHeight: 38,
            centerTitle:true,title: Text("${widget.data["name"]}"),backgroundColor: Colors.white,),
          body:
          PopScope(
            onPopInvoked: (sisPop){
                  ...
                  child: Row(
                    children: [
                      Expanded(
                          flex: 8,
                          child: Container(
                            margin: const EdgeInsets.only(left: 14,bottom: 2),
                      ...
                      Expanded(
                          ...
                          GestureDetector(
                            onTap: () async {
                              Map<String,dynamic> params = {"user_ids":widget.data["id"],
        ...
        color: Colors.white,
        alignment: Alignment.center,child: CircularProgressIndicator(strokeWidth: 1,color: Colors.red,),);
    });
  ...
  if(controller.msgList[index].fromUser.userId==pageController.userId){
    fromUser = FromUser(controller.msgList[index].fromUser.nickname,
        controller.msgList[index].fromUser.avatarUrl, _textController.text, controller.msgList[index].fromUser.userId);
      ...
      child:  Row(
          ...
          children: [
            Container(
              ...
              child: Text("${json['msg']}",style: TextStyle(fontSize: 10,color: Colors.white)),
              decoration: BoxDecoration(
      ...
      child: Row(
          ...
          children: [
            ...
            Container(
              constraints: BoxConstraints(maxWidth: mediaQuery.size.width-150),
              padding: EdgeInsets.all(10),
              child: Text("${json['msg']}",style: TextStyle(fontSize: 10,color: Colors.black),),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.all(Radius.circular(8)),
                  color: Colors.white
              ),
