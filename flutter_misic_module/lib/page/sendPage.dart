 ...
 //  var _isTextOverflow = false;
   return Scaffold(
     ...
     appBar: AppBar(
       ...
       actions: [Padding(padding: EdgeInsets.only(right: 10),child: TextButton(

           style:TextButton.styleFrom(backgroundColor: Colors.redAccent) ,
           onPressed: (){
             print("object------${widget.data['id']}----${_textController.text}-----${widget.data['type']}");
             ...
             Align(
               ...
               child:    Container(
                 ...
                 child: Row(
                   ...
                   children: [
                     getSquareImg(Url: widget.data['img'],
                         width: 50,
                         height: 50),
