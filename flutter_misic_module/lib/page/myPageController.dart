...
class PageControllers extends GetxController {
  ...
  set isOverlayVisible(bool isOverlayVisible) =>
      _isOverlayVisible.value = isOverlayVisible;
...
class myPageController extends GetxController {
  ...
  set recentlyPlayedSongs(List<SongListBean> value) =>
      _recentlyPlayedSongs.value = value;

  List<ShowSongSheet> get recentlyPlayedSongSheets =>
      _recentlyPlayedSongSheets.value;

  set recentlyPlayedSongSheets(List<ShowSongSheet> value) =>
      _recentlyPlayedSongSheets.value = value;

  List<SongSheetList> get myPageSongSheets => _myPageSongSheets.value;

  set myPageSongSheets(List<SongSheetList> value) =>
      _myPageSongSheets.value = value;

  List<AlbumListBean> get recentlyPlayedAlbums => _recentlyPlayedAlbums.value;

  set recentlyPlayedAlbums(List<AlbumListBean> value) =>
      _recentlyPlayedAlbums.value = value;
  ...
  createPlayer(String url, bool autoPlay, SourceType type) {
    ...
    _pool[url] = Player()
      ..setCommonDataSource(url, autoPlay: autoPlay, type: type)
      ..setLoop(0);
    if (_pool.length > 10) {
