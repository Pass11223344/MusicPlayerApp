                            ...
                            sliver: SliverAppBar(
                                              ...
                                              Expanded(
                                                ...
                                                child: TextButton.icon(
                                                  ...
                                                  ListController.albumInfo!.album.info.liked||widget.data["IsTheSame"]?  Icon(Icons.library_add_check,color: Colors.redAccent,size: 24,)
                                                      ...
                                                      : ListController.songSheet!.subscribed||widget.data["IsTheSame"]?Icon(Icons.library_add_check,color: Colors.redAccent,size: 24,)
                                                      :Icon(Icons.add_box,color:Colors.white,size:24,);
                                                })),
                                              ),
                                            ],
                              ...
                              bottom: PreferredSize(
                                ...
                                child: Container(
                                    ...
                                    child:TextButton.icon(
                                        onPressed: (){},
                                        label: Text("播放全部(${ListController.albumInfo!=null?ListController.albumInfo!.songs.length:ListController.songSheet!.cloudTrackCount+ListController.songSheet!.trackCount})",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color:Colors.black),),
                              ...
                              CustomScrollView(
                                slivers: [
                                  ...
                                  Obx((){
                                    return  SliverFixedExtentList(
                                      delegate: SliverChildBuilderDelegate(
                                          childCount: ListController.albumInfo!=null?ListController.albumInfo!.songs.length:ListController.songList?.length,
                                              (context,index){
                                            if(ListController.albumInfo!=null){
                                            ...
                                            Container(
                                              ...
                                              child:  ListTile(
                                                ...
                                                onTap: (){
                                                  if(pageController.lastId==ListController.songList?[index].id) return;
                                                  pageController.lastId = ListController.songList![index].id;

                                                  channel.invokeMethod("sendSongList",{
                                                    "title":widget.data['title']!=null?widget.data['title']:ListController.songSheet?.name,
                                                    "SongIndex":index,
                                            ...
                                            Container(
                                              ...
                                              child:  ListTile(
                                                ...
                                                onTap: (){
                                                  ...
                                                  if( pageController.lastAlbumId==ListController.albumInfo!.songs[index].id) {
                                                    return;
                                                  }

                                                  pageController.lastAlbumId = ListController.albumInfo!.songs[index].id;
                                  ...
                                  SliverToBoxAdapter(
                                      child:
                                      Obx((){
                                        print("object${ListController.songList.length}----${ListController.albumInfo?.album.size}----${ListController.songSheet?.trackCount}");
                                        return  Container(
                                            color: Colors.white,
                                            width: 70,height: (ListController.songSheet!=null?
                                        ListController.songList?.length==ListController.songSheet?.trackCount:
                                        ListController.albumInfo!.songs.length==ListController.albumInfo?.album.size) ?100:70,
                                            alignment: Alignment.center,
                                            child:
                                            (ListController.songSheet!=null?
