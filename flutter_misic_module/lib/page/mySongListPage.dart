...
class mySongListPageState extends State<mySongListPage> {
  final GlobalKey<mySongListPageState> _childKey = GlobalKey();
  ...
  static var dioRequest = DioRequest();
  final ScrollController _scrollController = ScrollController();

  Future<bool> isPop() async {
    print("object------------------------------0000000000000");
                                ...
                                child: TextButton.icon(
                                    ...
                                    label: Obx(() {
                                      return ListController.isSearch
                                          ? const Text("")
                                          : Text(
                                              "${widget.data['title'] != null ? ListController.expandedHeight > eHeight / 2 ? widget.data['title'] : "歌单" : ListController.albumInfo != null ? (ListController.expandedHeight > eHeight / 2 ? ListController.albumInfo?.album.name : "专辑") : (ListController.songSheet?.detailPageTitle == null ? ListController.expandedHeight > eHeight / 2 ? ListController.songSheet?.name : "歌单" : ListController.expandedHeight > eHeight / 2 ? ListController.songSheet?.name : "官方歌单")}",
                                              style: TextStyle(
                                                  fontSize: 16,
                                                  color: Colors.black),
                                            );
                                                              ...
                                                              return ListController
                                                                  ...
                                                                  : GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            width: ListController.songSheet!.sharedUsers.length == 0
                                                                                ? null
                                                                                : 60,
                                                                            child: Stack(
                                  ...
                                  bottom: PreferredSize(
                                    ...
                                    child: Container(
                                        ...
                                        child: TextButton.icon(
                                            onPressed: () {},
                                            label: Text(
                                              "播放全部(${ListController.albumInfo != null ? ListController.albumInfo!.songs.length : ListController.songSheet!.cloudTrackCount + ListController.songSheet!.trackCount})",
                                              style: TextStyle(
                                                  fontSize: 16,
                                ...
                                child: CustomScrollView(
                                  slivers: [
                                                        ...
                                                        const TextStyle(
                                                            ...
                                                            fontWeight:
                                                                FontWeight
                                                                    .bold),
                                                    subtitle: Text(
                                                      "${Utils.getSubTitle(ListController.songList![index].ar)}-${ListController.songList![index].al.name != null ? ListController.songList![index].al.name : ""}",
                                                      maxLines: 1,
                                                    ),
                                                    subtitleTextStyle:
                                                        const TextStyle(
                                    ...
                                    SliverToBoxAdapter(child: Obx(() {
                                      print(
                                          "object${ListController.songList.length}----${ListController.albumInfo?.album.size}----${ListController.songSheet?.trackCount}");
                                      return Container(
                                          color: Colors.white,
                                          width: 70,
                                          height: (ListController.songSheet != null
                                                  ? ListController.songList?.length ==
                                                      ListController
                                                          .songSheet?.trackCount
                                                  : ListController.albumInfo!
                                                          .songs.length ==
                                                      ListController.albumInfo
                                                          ?.album.size)
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              children: [
                                Center(
                                  child: getSquareImg(
                                      Url: ListController.albumInfo != null
                                          ? ListController
                              ...
                              child: TextButton(
                                onPressed: () async {
                                  ...
                                  if (await Utils.requestPermission(
                                      {"info": url, "origin": "myFragment"})) {
                                    pageController.path ??=
                                        await channel.invokeMethod("getPath");
                                    Utils.downloadImage(
                                            url, pageController.path)
                                        .then((flag) {
                                      Utils.showTopSnackBar(
                                          context, "下载${flag ? "成功" : "失败"}");
                                    });
                                  }
                                },
                                child: Text(
    ...
    switch (widget.data['type']) {
      ...
      case "to_page_song_list":
        ...
        var SList = await dioRequest.executeGet(
            ...
            params: {"id": id, "limit": 20, "offset": 0});
        ...
        Future.microtask(() async {
          ...
          if (SongSheet != null && SList != null) {
            ...
            print("object-------加载完成${pageController.pageIsOk}");
          }
        });
        break;
