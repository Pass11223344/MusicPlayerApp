...
class myPageState extends State<myPage> with TickerProviderStateMixin{
   ...
   static  final GlobalKey<mySongListPageState> childKey = GlobalKey<mySongListPageState>();
 ...
 //   _myPageController = Get.find<myPageController>();
  ...
  Widget build(BuildContext context) {
    ...
    return Obx((){
      return _myPageController.users!=null?  Scaffold(
        // 设置body背景延伸到Appbar下方
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      if(await Utils.requestPermission({"info":""})){
                                        var path =   await Utils.chooseImage();
                                      }


                                    },
                                    child:  Positioned.fill(
                                      child:  getSquareImg(Url: _myPageController.users!.backgroundUrl ,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child:getCircularImg(url: _myPageController.users!.avatarUrl,size: 85),
                                        ),
                                        Container(
                                        ...
                                        Container(
                                          ...
                                          child:  Row(
                                            ...
                                            mainAxisAlignment: MainAxisAlignment.center,
                                            children: [
                                              Text("${_myPageController.users!.followeds}",style: TextStyle(fontSize: 12,color: Colors.white,fontWeight:FontWeight.bold )),

                                              Text("关注",style: TextStyle(fontSize: 10,color: Colors.white38)),
                                              SizedBox(width: 10,),
                                              Text("${_myPageController.users!.follows}",style: TextStyle(fontSize: 12,color: Colors.white,fontWeight:FontWeight.bold )),
                                              Text("粉丝",style: TextStyle(fontSize: 10,color: Colors.white38)),
                                              SizedBox(width: 10,),
                                              Text("LV.${_myPageController.users!.eventCount}",style: TextStyle(fontSize: 12,color: Colors.white,fontWeight:FontWeight.bold )),
                                  ...
                                  InkWell(
                                    onTap: (){
                                      channel.invokeMethod("upSheetId",
                                          {"sheetId":_myPageController.myPageSongSheets[index].id});
                                      Navigator.pushNamed(context, "main/songListPage",arguments: {"type":"to_my_page_song_list",
                                        "id":_myPageController.myPageSongSheets[index].id.toString(),
                                        "title":index==0?"我喜欢的音乐":_myPageController.myPageSongSheets[index].name,
                                        "IsTheSame":_myPageController.myPageSongSheets[index].creator.userId==_myPageController.users!.userId
                                      });
                                    },
                                    child:Padding(padding: EdgeInsets.only(left: 10,right: 10,bottom: 10),
                                      child: Row(
                                        children: [
                                          getSquareImg(Url:  _myPageController.myPageSongSheets[index].coverImgUrl,width:  80,height:  80),
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  ...
                                                  index==0?"我喜欢的音乐":_myPageController.myPageSongSheets[index].name,style: const TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.bold),maxLines: 1,overflow: TextOverflow.ellipsis,),
                                                Text(
                                                    textAlign: TextAlign.left,
                                                    index==0?"${_myPageController.myPageSongSheets[index].trackCount+_myPageController.myPageSongSheets[index]!.cloudTrackCount}首·${_myPageController.myPageSongSheets[index].playCount}次播放"
                                                        :"歌单·${_myPageController.myPageSongSheets[index].trackCount}首·${_myPageController.myPageSongSheets[index].creator.nickname}",style: const TextStyle(fontSize: 12,color: Colors.grey),maxLines: 1,overflow: TextOverflow.ellipsis),
                    ...
                    slivers: <Widget>[
                      ...
                      SliverFixedExtentList(
                          ...
                          SliverChildBuilderDelegate(
                              childCount: _myPageController.myPageSongSheets.length,
                                  (context,index){
                                if(_myPageController.myPageSongSheets[index].creator.userId==_myPageController.users!.userId){
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    textAlign: TextAlign.left,
                                                    index==0?"${_myPageController.myPageSongSheets[index].trackCount}首·${_myPageController.myPageSongSheets[index].playCount}次播放"
                                                        :"歌单·${_myPageController.myPageSongSheets[index].trackCount}首·${_myPageController.myPageSongSheets[index].creator.nickname}",style: const TextStyle(fontSize: 12,color: Colors.grey),maxLines: 1,overflow: TextOverflow.ellipsis),
                ...
                SliverChildBuilderDelegate(
                    childCount: _myPageController.videoList.length,
                      ...
                      child:  Padding(padding: EdgeInsets.only(left: 10,right: 10,bottom: 10),
                        child: Row(
                          children: [
                            getSquareImg(Url: _myPageController.videoList![index].data.coverUrl, width: 100, height: 80),
                            ...
                            Container(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("${_myPageController.videoList![index].data.name}",style:  TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.bold),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                Text("${Utils.formatTime(_myPageController.videoList![index].data.duration)} "
                                    "${_myPageController.videoList![index].resourceType=="MV"?Utils.getSubTitle(_myPageController.videoList![index].data.artists)
                                    :"by ${_myPageController.videoList![index].data.creator!.nickname}"}",style: TextStyle(fontSize: 12,color: Colors.grey),maxLines: 1,overflow: TextOverflow.ellipsis)
...
return  Builder(builder: (context){
  ...
  void navigatorComment(Events e, String? imageUrl, String? title, String creatorName, BuildContext context, int index) {
    var params = {
  ...
  getTabData()  {
    dioRequest.executeGet(url: "/record/recent/video").then((value){
      _myPageController.videoList= (value['list'] as List<dynamic>).map((json)=>VideoListBean.fromJson(json)).toList();
      _myPageController.videoInfoBean = List.generate(_myPageController.videoList.length, (index)=>null);
     // _myPageController.players = List.generate(_myPageController.videoList.length, (index)=>null);

    });
    //relay;
     dioRequest.executeGet(url: "/user/event",params: {"uid": pageController.userId}).then((value){
  ...
  pageThreeItem(Events event,String imageUrl,String title,String creatorName,int index){
                  ...
                  child:    Row(
                    ...
                    children: [
                      TextButton.icon(onPressed: (){
                        navigatorComment(event, imageUrl, title, creatorName, context,index);
                      }, label: Text("${event.info.commentCount==0?"评论":event.info.commentCount}",style: TextStyle(color: Colors.grey),),icon: Icon(Icons.question_answer,color: Colors.grey,),),
                      TextButton.icon(onPressed: ()  async {
                       ...
                       _myPageController.upCount(index);
                        ...
                        if ( _myPageController.events[index].info.liked){
                         ...
                         await  dioRequest.executeGet(url: "/resource/like",params: {"t":t,"type":6,"threadId":event.threadId});

                      }, label:
                      Text("${ _myPageController.events[index].info.likedCount==0?"赞"
                          : _myPageController.events[index].info.likedCount}",style: TextStyle(color: Colors.grey)),

                          icon:  Icon(Icons.favorite_border_outlined,color: _myPageController.events[index].info.liked? Colors.red: Colors.grey,)),
        ...
        actions: [
          TextButton(
            ...
            onPressed: () {
              ...
              dioRequest.executeGet(url: "/event/del",params: {"evId": _myPageController.events[index].id}).then((value){
