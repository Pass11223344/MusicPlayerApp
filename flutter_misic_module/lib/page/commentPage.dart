...
class commentPageState extends State<commentPage>
      ...
      body: Stack(
        children: [
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Obx(() {
                                                                return Text(
                                                                    "最新",
                                                                    style: TextStyle(
                                                                        color: commentController.sortType ==
                                                                                3
                                                                            ? Colors.black
                                                                            : Colors.grey));
                                                              }),
                              ...
                              body: Obx(() => commentController.secondPage
                                  ? Stack(
                                      children: [
                                        ...
                                        Obx(() {
                                          return commentController.isSend
                                              ? Stack(
                                                  children: [
                                                    Container(
                                                      width: double.infinity,
          ...
          Obx(() => Visibility(
              ...
              child: Align(
                  alignment: Alignment.bottomCenter, child: inputView()))),
        ],
      ),
    );
  }
  ...
  getInfo() async {
    ...
    executeGet =
        await dioRequest.executeGet(url: "/comment/new", params: params);
    if (executeGet != "error") {
          ...
          children: [
            ...
            Container(
                ...
                child: WPopupMenu(
                    ...
                    actions: event.user.userId == commentInfo?['userId']
                        ? actions1
                        : actions,
                    key: null,
                    child: InkWell(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Obx(() {
                                return Visibility(
                                    visible: commentController.commentInfo!
                                            .comments[index].replyCount !=
                                        0,
                                    child: GestureDetector(
                                      onTap: () {
                                        commentController.isTraceComment =
                                            false;
                                        ...
                                        dioRequest.executeGet(
                                          ...
                                          commentController.replyCommentInfo =
                                              CommentInfoBean.fromJson(value);
                                          commentController.isTraceComment =
                                              true;
                                        });
                                      },
                                      child: Padding(
                                        ...
                                        child: Text(
                                            "${commentController.commentInfo!.comments[index].replyCount}条回复 >",
                                            style: const TextStyle(
                        ...
                        child: NotificationListener<ScrollNotification>(
                            onNotification: ((scrollNotification) {
                              if (scrollNotification
                                ...
                                if (!commentController.addMoreReplyListIsOk &&
                                    commentController
                                        .replyCommentInfo!.hasMore) {
                                  addMoreReplyList(
                                      commentInfo?["commentType"],
                                      commentController
                                          .replyCommentInfo!
                              ...
                              slivers: [
                                ...
                                Obx(() {
                                  return commentController.isTraceComment
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  Text(commentController
                                                                      ...
                                                                      .nickname),
                                                                  Text(
                                                                      "${commentController.replyCommentInfo!.comments[i].timeStr}  ${commentController.replyCommentInfo!.comments[i].ipLocation.location}"),
                                                                  Container(
                                                                  ...
                                                                  Visibility(
                                                                      ...
                                                                      child: Container(
                                                                        ...
                                                                        child: RichText(
                                                                          ...
                                                                          TextSpan(
                                                                              text: "  ${commentController.replyCommentInfo!.comments[i].beReplied[0].user.nickname}",
                                                                              style: const TextStyle(color: Colors.blueAccent)),
                                                                          TextSpan(
                                                                              text: " : ${commentController.replyCommentInfo!.comments[i].beReplied[0].content}",
                                      ...
                                      : SliverToBoxAdapter(
                                          child: Utils.loadingView(
                                              Alignment.center),
                                        );
                                }),
                                SliverToBoxAdapter(child: Obx(() {
                                  return commentController.replyCommentInfo !=
                                          null
                                      ? commentController
                                              .replyCommentInfo!.hasMore
  ...
  sendOrRemoveComment(
      int t, int type, String id, String? comment, int? commentId, int index) {
    // t:1:发送，2:回复 ，0:删除
    var params;
    switch (t) {
      case 0:
        params = {"t": t, "type": type, "id": id, "commentId": commentId};

        break;
      case 1:
        params = {"t": t, "type": type, "id": id, "content": comment};
        break;
      case 2:
        params = {
          "t": t,
  ...
  addMoreList() {
    ...
    print(
        "object加载更多------------------------------------------------${commentInfo?["commentType"]}---"
    ...
    switch (commentController.sortType) {
      ...
      case 3:
        params = {
          ...
          "sortType": commentController.sortType,
          "pageNo": 2,
          "cursor": commentController.commentInfo!
              .comments[commentController.commentInfo!.comments.length - 1].time
        };
        break;
    }
    dioRequest.executeGet(url: "/comment/new", params: params).then((value) {
      if (value != "error") {
        ...
        print(
            "aaaaaaaaaaaaaaaaaaaawwwwwwww${commentController.commentInfo?.comments.length}");
