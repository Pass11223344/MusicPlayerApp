...
import 'package:wangyiyun_flutter_module/bean/CommentInfoBean.dart';
import 'package:wangyiyun_flutter_module/page/commentPageController.dart';
...
class commentPageState extends State<commentPage>
        ...
        children: [
          Scaffold(
            ...
            body: Stack(
              children: [
                Center(
                    child: commentController.allPage
                        ? Container(
  ...
  void receiveDataFromAndroid() {
    channel.setMethodCallHandler((call) async {
      if (call.method == "commentChannel") {
        ...
        await getInfo();
        commentController.allPage = !commentController.allPage;
        setState(() {});
      }
    });
  }
  ...
  getInfo() async {
    ...
    executeGet = await DioRequest()
        .executeGet(url: commentInfo?["commentUrl"], params: params);
    if (executeGet != "error") {
